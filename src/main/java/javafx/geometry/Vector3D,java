...
public class Vector3D implements Cloneable, java.io.Serializable {
    ...
    public Vector3D interpolate(Vector3D vector, double value) {
        this.x = ((1 - value) * this.x) + (value * vector.x);
        this.y = ((1 - value) * this.y) + (value * vector.y);
        this.z = ((1 - value) * this.z) + (value * vector.z);
        return this;
    }
    ...
    public Vector3D interpolate(double x, double y, double z, double value) {
        this.x = ((1 - value) * this.x) + (value * x);
        this.y = ((1 - value) * this.y) + (value * y);
        this.z = ((1 - value) * this.z) + (value * z);
        return this;
    }
    ...
    @Override public boolean equals(Object object) {
        ...
        if(Double.compare(y, vector.y) != 0) return false;
        if(Double.compare(z, vector.z) != 0) return false;
        return true;
    }
